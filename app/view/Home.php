...
<head>
    ...
    <link rel="stylesheet" href="<?=URLROOT?>/public/css/commonStyle.css">
    <link rel="stylesheet" href="http://localhost/Nexus-Crypto-Wallet/public/css/style.css">
...
<body>
    ...
    <header>
        ...
        <ul class="nav" id="nav">
            <ul class="navLogo">
                <a href="./index.html">
                     <img src="<?=URLROOT?>/public/img/logo-white.png" alt="">
               </a>
            </ul>
    ...
    <section class="hero gridSection">
        ...
        <div class="sectionPic bouncepic" id="sectionPic">
            <img src="<?=URLROOT?>/public/img/hero-image.png" alt="">
        </div>
    </section>
    ...
    <section>
        <div class="carouselContainer">
            <div class="eachCarousel eachCarouselBorder">
                <img src="<?=URLROOT?>/public/img/bitcoin-icon.png" alt="">
            ...
            <div class="eachCarousel">
                <img src="<?=URLROOT?>/public/img/ethereum-icon.png" alt="">
                <article class="carouselDesc">
            ...
            <div class="eachCarousel">
                <img src="<?=URLROOT?>/public/img/tether-icon.png" alt="">
                <article class="carouselDesc">
    ...
    <section class="gridSection">
        <div class="sectionDesc processessDesc">
            ...
            <div class="eachProcesses">
                <img src="<?=URLROOT?>/public/img/handshake-icon-white-line.svg" alt="handshake">
            ...
            <div class="eachProcesses">
                <img src="<?=URLROOT?>/public/img/cart-icon-white-line.svg" alt="handshake">
                <div class="eachprocessesPara">
        ...
        <div class="sectionPic bouncepic processesPic" id="sectionPic">
            <img src="<?=URLROOT?>/public/img/chain-process-img.png" alt="">
        </div>
    </section>
    ...
    <section class="gridSection">
        <div class="sectionDesc marketDesc">
            ...
            <div class="eachMarket">
                <img src="<?=URLROOT?>/public/img/buy-icon-color.svg" alt="handshake">
                <div>
            ...
            <div class="eachMarket">
                <img src="<?=URLROOT?>/public/img/trading-icon-color.svg" alt="handshake">
                <div>
            ...
            <div class="eachMarket">
                <img src="<?=URLROOT?>/public/img/support-icon-color.svg" alt="handshake">
                <div>
            ...
            <div class="eachMarket">
                <img src="<?=URLROOT?>/public/img/online-icon-color.svg" alt="handshake">
                <div>
    ...
    <section class="gridSection">
        ...
        <div class="sectionPic dashboardPic">
            <img src="<?=URLROOT?>/public/img/dashboard-dark.jpg" alt="">
        </div>
    ...
    <div class="fundSection">
        <div class="sectionDesc">
            ...
            <div class="fundsContainer">
                <div class="fund">
                    <img src="<?=URLROOT?>/public/img/cryptocurrency-white-icon.svg" alt="cryptocurrency">
                ...
                <div class="fund">
                    <img src="<?=URLROOT?>/public/img/blockchain-white-icon.svg" alt="cryptocurrency">
                ...
                <div class="fund">
                    <img src="<?=URLROOT?>/public/img/cryptocurrency-sell-white-icon.svg" alt="cryptocurrency">
                ...
                <div class="fund">
                    <img src="<?=URLROOT?>/public/img/cryptocurrency-card-white-icon.svg" alt="cryptocurrency">
    ...
    <section class="gridSection">
        ...
        <div class="sectionPic bouncepic newsletterPic">
            <img src="<?=URLROOT?>/public/img/newsletter.png" alt="">
        </div>
    </section>
        ...
        <div class="footerlinksContainer">
            <div class="footerAboutus">
                ...
                <div class="footersociallinkContainer">
                    <img class="sociallink" src="<?=URLROOT?>/img/fabook-icon-white.svg" alt="">
                    <img class="sociallink" src="<?=URLROOT?>/img/twitter-icon-white.svg" alt="">
                    <img class="sociallink" src="<?=URLROOT?>/img/inkedin-icon-white.svg" alt="">
                    <img class="sociallink" src="<?=URLROOT?>/img/whatsapp-icon-white.svg" alt="">
                </div>
            </div>
