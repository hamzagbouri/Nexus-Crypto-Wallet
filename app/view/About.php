...
<body>
     ...
     <header>
        ...
        <ul class="nav" id="nav">
            ...
            <li class="sociallinkContainer">
                <img class="sociallink" src="<?=URLROOT?>/public/img/fabook-icon-white.svg" alt="">
                <img class="sociallink" src="<?=URLROOT?>/public/img/twitter-icon-white.svg" alt="">
                <img class="sociallink" src="<?=URLROOT?>/public/img/inkedin-icon-white.svg" alt="">
                <img class="sociallink" src="<?=URLROOT?>/public/img/whatsapp-icon-white.svg" alt="">
            </li>
        </ul>
        <div id="barContainer">
    ...
    <section class="gridSection">
        ...
        <div class="sectionPic bouncepic aboutusPic" id="sectionPic">
            <img src="<?=URLROOT?>/public/img/about-hero.png" alt="">
        </div>
    </section>
    ...
    <div class="services">
        <div class="aboutusimgContainer">
            <img src="<?=URLROOT?>/public/img/about-image-1.jpg" alt="">
            <img src="<?=URLROOT?>/public/img/about-image-2.jpg" alt="">
        </div>

        <div class="offers">
            <div class="eachOffer">
                <img src="<?=URLROOT?>/public/img/fast-forward-icon-white.svg" alt="">
                <div class="offerDesc">
            ...
            <div class="eachOffer">
                <img src="<?=URLROOT?>/public/img/support-agent-icon-white.svg" alt="">
                <div class="offerDesc">
                    <h1>Best Support</h1>
            ...
            <div class="eachOffer">
                <img src="<?=URLROOT?>/public/img/progress-warning-icon-white.svg" alt="">
                <div class="offerDesc">
                    <h1>Best Progress</h1>
    ...
    <!-- Play Video -->
       <section class="videoSection">
           ...
           <div class="videoContainer">
            <div class="video">
                <img src="<?=URLROOT?>/public/img/about-video.jpg" class="thumbnail" alt="">
                <img src="<?=URLROOT?>/public/img/video-play-icon-white.svg" class="playIcon" alt="">
            </div>
            <p>
    ...
    <section class="teamSection">
        ...
        <div class="carouselContainer">
            <div class="eachCarousel eachTeam">
                <div class="teamPic">
                    <img src="<?=URLROOT?>/public/img/team-image-1.jpg" alt="">
                    <div class="teamSocialLink">
                        <img src="<?=URLROOT?>/public/img/Facebook_black.svg" alt="">
                        <img src="<?=URLROOT?>/public/img/Vimeo_black.svg" alt="">
                        <img src="<?=URLROOT?>/public/img/Twitter_black.svg" alt="">
                        <img src="<?=URLROOT?>/public/img/Instagram_black.svg" alt="">
                    </div>
                </div>
                <div class="teamDesc">
            ...
            <div class="eachCarousel eachTeam">
                <div class="teamPic">
                    <img src="<?=URLROOT?>/public/img/team-image-2.jpg" alt="">
                    <div class="teamSocialLink">
                        <img src="<?=URLROOT?>/public/img/Facebook_black.svg" alt="">
                        <img src="<?=URLROOT?>/public/img/Vimeo_black.svg" alt="">
                        <img src="<?=URLROOT?>/public/img/Twitter_black.svg" alt="">
            ...
            <div class="eachCarousel eachTeam">
                <div class="teamPic">
                    <img src="<?=URLROOT?>/public/img/team-image-3.jpg" alt="">
                    <div class="teamSocialLink">
                        <img src="<?=URLROOT?>/public/img/Facebook_black.svg" alt="">
                        <img src="<?=URLROOT?>/public/img/Vimeo_black.svg" alt="">
                        <img src="<?=URLROOT?>/public/img/Twitter_black.svg" alt="">
